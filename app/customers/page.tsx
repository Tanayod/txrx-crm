      ...
      <div className="flex-1 ml-56 p-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={openCreate} className="bg-[#4338CA] text-white px-4 py-2 rounded-lg text-sm hover:bg-[#312E81] flex items-center gap-2">
        ...
        <div className="bg-white border border-gray-100 rounded-xl p-4 mb-4 space-y-3">
          ...
          <div className="flex gap-3 items-end">
            ...
            <div className="flex justify-between items-center flex-1">
              ...
              <button onClick={() => { setSearch(''); setFilterType('') }} className="text-xs text-[#4338CA] hover:underline">ล้างตัวกรอง</button>
            </div>
          </div>
        </div>
              ...
              <div key={c.id} className={`grid grid-cols-8 gap-2 px-5 py-3 border-b border-gray-50 text-sm hover:bg-gray-50 items-center ${c.is_active === false ? 'opacity-50' : ''}`}>
                ...
                <span>
                  {c.opening_balance > 0 ? (
                    ...
                    <button onClick={() => openDebtModal(c)} className="text-xs text-gray-400 hover:text-[#4338CA] hover:underline">
                      ดูยอดค้าง
                    </button>
                  )}
                </span>
        ...
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-lg max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex gap-2 mt-5 justify-end">
              ...
              <button onClick={handleSave} className="px-4 py-2 text-sm bg-[#4338CA] text-white rounded-lg hover:bg-[#312E81]">บันทึก</button>
            </div>
          </div>
        </div>
      )}
